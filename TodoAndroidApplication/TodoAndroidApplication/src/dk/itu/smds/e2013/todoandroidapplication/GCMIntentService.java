...
import dk.itu.smds.e2013.todoandroidapplication.deviceinfoendpoint.Deviceinfoendpoint;
import dk.itu.smds.e2013.todoandroidapplication.deviceinfoendpoint.model.DeviceInfo;
...
public class GCMIntentService extends GCMBaseIntentService {
	 ...
	 * information.
	 */
	protected static final String PROJECT_NUMBER = "115406338126";
	...
	public void onMessage(Context context, Intent intent) {
		...
		// Rao: 20131103: Modified the code to react to the messages send from
		// both MessageDataEndpoint and TodoEndoint classes.
		// The type of messages we get here can be a message from Index.html
		// page or
		// when a sendTo REST API (TodoEndoint) is called.
		//

		String message = intent.getStringExtra("message");

		String newtodoId = intent.getStringExtra("new_todo_id");
		...
		if (newtodoId != null) {
			...
			sendNotificationIntent(context, "Id of newly created Todo:\n\n"
					+ intent.getStringExtra("new_todo_id"), true, false);
